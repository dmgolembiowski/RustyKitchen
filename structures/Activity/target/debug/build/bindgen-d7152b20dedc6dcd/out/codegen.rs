mod derive_debug {
    ...
    pub fn gen_debug_impl(ctx: &BindgenContext, fields: &[Field], item: &Item,
                          kind: CompKind) -> Vec<ast::ImplItem> {
        ...
        if item.is_opaque(ctx, &()) {
            ...
            match kind {
                CompKind::Union => { format_string.push_str("union"); }
                CompKind::Struct => {
                    ...
                    for (i, (fstring, token)) in processed_fields.enumerate()
                        ...
                        if !token.is_empty() {
                            tokens.push(TokenTree::Token(DUMMY_SP,
                                                         Token::Comma));
                            tokens.extend(token);
                        }
                ...
                ::quasi::parse_item_panic(&mut ::syntax::parse::new_parser_from_tts(ext_cx.parse_sess(),
                                                                                    {
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("f"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::OpenDelim(::syntax::parse::token::Brace)));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("write"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Comma));
                                                                                        tt.extend(::quasi::ToTokens::to_tokens(&format_string,
                                                                                                                               ext_cx).into_iter());
                                                                                        tt.extend(::quasi::ToTokens::to_tokens(&tokens,
                                                                                                                               ext_cx).into_iter());
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::CloseDelim(::syntax::parse::token::Paren)));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
    ...
    pub trait ImplDebug<'a> {
        ...
        fn impl_debug(&self, ctx: &BindgenContext, extra: Self::Extra)
    ...
    impl <'a> ImplDebug<'a> for FieldData {
        ...
        =
        ();
        fn impl_debug(&self, ctx: &BindgenContext, _: Self::Extra)
         -> Option<(String, Vec<TokenTree>)> {
            ...
            for (i, bu) in self.bitfields().iter().enumerate() {
                ...
                tokens.extend({
                                  let ext_cx = &*ctx.ext_cx();
                                  {
                                      ...
                                      tt.extend(::quasi::ToTokens::to_tokens(&name_ident,
                                                                             ext_cx).into_iter());
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
    ...
    impl <'a> ImplDebug<'a> for Item {
        ...
        =
        &'a str;
        fn impl_debug(&self, ctx: &BindgenContext, name: Self::Extra)
         -> Option<(String, Vec<TokenTree>)> {
            ...
            fn debug_print(ctx: &BindgenContext, name: &str,
            ...
            match *ty.kind() {
                ...
                TypeKind::Reference(..) | TypeKind::BlockPointer |
                TypeKind::UnresolvedTypeRef(..) | TypeKind::ObjCInterface(..)
                | TypeKind::ObjCId | TypeKind::Comp(..) | TypeKind::ObjCSel =>
                debug_print(ctx, name, name_ident),
                TypeKind::TemplateInstantiation(ref inst) => {
                    if inst.is_opaque(ctx, self) {
                        Some((format!("{}: opaque" , name), vec!()))
                    } else { debug_print(ctx, name, name_ident) }
                }
                TypeKind::TypeParam => {
                    Some((format!("{}: Non-debuggable generic" , name),
                          vec!()))
                }
                TypeKind::Array(_, len) => {
                    if self.has_type_param_in_array(ctx) {
                        Some((format!("{}: Array with length {}" , name ,
                                      len), vec!()))
                        ...
                        Some((format!("{}: [{{}}]" , name),
                              {
                                  let ext_cx = &*ctx.ext_cx();
                                  {
                                      ...
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Dot));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Ident(ext_cx.ident_of("iter"))));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::CloseDelim(::syntax::parse::token::Paren)));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Dot));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Ident(ext_cx.ident_of("enumerate"))));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::CloseDelim(::syntax::parse::token::Paren)));
                                      ...
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Ident(ext_cx.ident_of("i"))));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Comma));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                      ...
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::BinOp(::syntax::parse::token::Or)));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Ident(ext_cx.ident_of("format"))));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Not));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                      ...
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Dot));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Ident(ext_cx.ident_of("collect"))));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::ModSep));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Lt));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Ident(ext_cx.ident_of("String"))));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::Gt));
                                      tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                      ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                ...
                TypeKind::ResolvedTypeRef(t) | TypeKind::TemplateAlias(t, _) |
                TypeKind::Alias(t) => {
                ...
                TypeKind::Pointer(inner) => {
                    ...
                    match *inner_type.kind() {
                        TypeKind::Function(ref sig) if
                        !sig.can_trivially_derive_debug() => {
                            Some((format!("{}: FunctionPointer" , name),
                                  vec!()))
                        }
...
mod helpers {
    ...
    pub fn blob(layout: Layout) -> P<ast::Ty> {
        ...
        if data_len == 1 {
            inner_ty
        } else { aster::ty::TyBuilder::new().array(data_len).build(inner_ty) }
    }
    pub mod ast_ty {
        use aster;
        use ir::context::BindgenContext;
...
fn top_level_path(ctx: &BindgenContext, item: &Item) -> Vec<ast::Ident> {
    ...
    if ctx.options().enable_cxx_namespaces {
        ...
        for _ in 0..item.codegen_depth(ctx) { path.push(super_.clone()); }
    }
    path
}
...
trait CodeGenerator {
    ...
    fn codegen<'a>(&self, ctx: &BindgenContext,
                   result: &mut CodegenResult<'a>, extra: &Self::Extra);
}
impl CodeGenerator for Item {
    ...
    ();
    fn codegen<'a>(&self, ctx: &BindgenContext,
                   result: &mut CodegenResult<'a>, _extra: &()) {
        if !self.is_enabled_for_codegen(ctx) { return; }
        ...
        match *self.kind() {
            ...
            ItemKind::Function(ref fun) => { fun.codegen(ctx, result, self); }
            ItemKind::Var(ref var) => { var.codegen(ctx, result, self); }
            ItemKind::Type(ref ty) => { ty.codegen(ctx, result, self); }
        }
    }
}
impl CodeGenerator for Module {
    ...
    Item;
    fn codegen<'a>(&self, ctx: &BindgenContext,
                   result: &mut CodegenResult<'a>, item: &Item) {
...
impl CodeGenerator for Type {
    ...
    fn codegen<'a>(&self, ctx: &BindgenContext,
        ...
        match *self.kind() {
            ...
            TypeKind::ResolvedTypeRef(..) | TypeKind::Opaque |
            TypeKind::TypeParam => {
                return;
            }
            TypeKind::TemplateInstantiation(ref inst) => {
...
impl <'a> CodeGenerator for Vtable<'a> {
    ...
    fn codegen<'b>(&self, ctx: &BindgenContext,
                   result: &mut CodegenResult<'b>, item: &Item) {
...
trait FieldCodegen<'a> {
    ...
    fn codegen<F,
               M>(&self, ctx: &BindgenContext, fields_should_be_private: bool,
                  codegen_depth: usize, accessor_kind: FieldAccessorKind,
                  parent: &CompInfo, anon_field_names: &mut AnonFieldNames,
     ...
     M: Extend<ast::ImplItem> {
        match *self {
            Field::DataMember(ref data) => {
                data.codegen(ctx, fields_should_be_private, codegen_depth,
                             accessor_kind, parent, anon_field_names, result,
                             struct_layout, fields, methods, ());
            }
            Field::Bitfields(ref unit) => {
                unit.codegen(ctx, fields_should_be_private, codegen_depth,
                             accessor_kind, parent, anon_field_names, result,
                             struct_layout, fields, methods, ());
            }
        }
...
impl BitfieldUnit {
    ...
    fn initial_ctor_impl(&self, ctx: &BindgenContext,
        ...
        let fn_prefix =
            if ctx.options().rust_features().const_fn() {
                {
                    let ext_cx = &*ctx.ext_cx();
                    {
                        #[allow(unused_imports)]
    ...
    fn codegen<F,
     ...
     M: Extend<ast::ImplItem> {
        ...
        for bf in self.bitfields() {
            bf.codegen(ctx, fields_should_be_private, codegen_depth,
                       accessor_kind, parent, anon_field_names, result,
                       struct_layout, fields, methods,
...
impl <'a> FieldCodegen<'a> for Bitfield {
    ...
    fn codegen<F,
               M>(&self, ctx: &BindgenContext,
                  _fields_should_be_private: bool, _codegen_depth: usize,
...
impl CodeGenerator for CompInfo {
    ...
    fn codegen<'a>(&self, ctx: &BindgenContext,
        ...
        if item.can_derive_hash(ctx) { derives.push("Hash"); }
        if item.can_derive_partialeq(ctx) { derives.push("PartialEq"); }
        if item.can_derive_eq(ctx) { derives.push("Eq"); }
        if !derives.is_empty() {
        ...
        for (i, base) in self.base_members().iter().enumerate() {
            ...
            if base_ty.is_unsized(ctx, &base.ty) { continue ; }
        ...
        if is_union {
            result.saw_union();
            if !self.can_be_rust_union(ctx) { result.saw_bindgen_union(); }
        }
        let layout = item.kind().expect_type().layout(ctx);
        ...
        for field in self.fields() {
            field.codegen(ctx, fields_should_be_private, codegen_depth,
                          struct_accessor_kind, self, &mut anon_field_names,
                          result, &mut struct_layout, &mut fields,
                          &mut methods, ());
        }
        if is_union {
        ...
        if self.is_unsized(ctx, &item.id()) {
            let has_address =
                if is_opaque {
                    layout.is_none()
                } else { layout.map_or(true, |l| l.size != 0) };
            if has_address {
                ...
                if let Some(layout) = layout {
                    ...
                    let too_many_base_vtables =
                        self.base_members().iter().filter(|base|
                                                              ctx.lookup_item_id_has_vtable(&base.ty)).count()
                            > 1;
        ...
        if needs_debug_impl {
            let impl_ =
                derive_debug::gen_debug_impl(ctx, self.fields(), item,
                                             self.kind());
            let debug_impl =
                aster::AstBuilder::new().item().impl_().trait_().id("::std::fmt::Debug").build().with_generics(generics.clone()).with_items(impl_).build_ty(ty_for_impl.clone());
...
trait MethodCodegen {
    fn codegen_method<'a>(&self, ctx: &BindgenContext,
                          ...
                          result: &mut CodegenResult<'a>, parent: &CompInfo);
}
impl MethodCodegen for Method {
    fn codegen_method<'a>(&self, ctx: &BindgenContext,
                          ...
                          _parent: &CompInfo) {
        assert!({
                let cc = & ctx . options (  ) . codegen_config ; match self .
                kind (  ) {
                MethodKind :: Constructor => cc . constructors , MethodKind ::
                Destructor => cc . destructors , MethodKind ::
                VirtualDestructor => cc . destructors , MethodKind :: Static |
    ...
    fn try_to_opaque(&self, ctx: &BindgenContext, extra: &Self::Extra)
     -> error::Result<P<ast::Ty>> {
        self.try_get_layout(ctx,
                            extra).map(|layout| { helpers::blob(layout) })
    }
}
...
mod utils {
    ...
    pub fn prepend_union_types(ctx: &BindgenContext,
                ...
                ::quasi::parse_item_panic(&mut ::syntax::parse::new_parser_from_tts(ext_cx.parse_sess(),
                                                                                    {
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Lt));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("H"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Colon));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::ModSep));
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::ModSep));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("Hasher"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Gt));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Comma));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("_state"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Colon));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::BinOp(::syntax::parse::token::And)));
        ...
        let union_field_partialeq_impl =
            {
                let ext_cx = &*&ctx.ext_cx();
                ::quasi::parse_item_panic(&mut ::syntax::parse::new_parser_from_tts(ext_cx.parse_sess(),
                                                                                    {
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::ModSep));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("cmp"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::ModSep));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("fn"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("eq"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::OpenDelim(::syntax::parse::token::Paren)));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::BinOp(::syntax::parse::token::And)));
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Comma));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("_other"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Colon));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::BinOp(::syntax::parse::token::And)));
                                                                                        ...
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::RArrow));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("bool"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::OpenDelim(::syntax::parse::token::Brace)));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::Ident(ext_cx.ident_of("true"))));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::CloseDelim(::syntax::parse::token::Brace)));
                                                                                        tt.push(::syntax::tokenstream::TokenTree::Token(_sp,
                                                                                                                                        ::syntax::parse::token::CloseDelim(::syntax::parse::token::Brace)));
        ...
        let items =
            vec!(union_field_decl , union_field_impl ,
                 ...
                 union_field_hash_impl , union_field_partialeq_impl ,
                 union_field_eq_impl);
        let old_items = mem::replace(result, items);
        result.extend(old_items.into_iter());
    }
